import 'package:bloodzone/admin_Search_page.dart';
...
class adprofile extends StatefulWidget {
  ...
  var id ;
  adprofile({Key? key, required this.id}) : super(key: key);
                            ...
                            showDialog(
                              ...
                              return AlertDialog(
                                ...
                                content: const SizedBox(
                                  height: 80,
                                    child: Center(
                                        child: Text('Confirm to Block ?'))),
                                actions: [
                                  Padding(
                                    padding: const EdgeInsets.all(10),
                                    child: ElevatedButton(onPressed: () {

                                    }, child: Text('No',style: TextStyle(color: Colors.green[300]),)
                                    ),
                                  ),
                                  Padding(
                                    padding: const EdgeInsets.all(10),
                                ...
                                actions: [
                                  ...
                                  Padding(
                                    ...
                                    child: ElevatedButton(onPressed: () {
                                      ...
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => const adsearch(),));
